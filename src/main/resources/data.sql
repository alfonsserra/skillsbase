...
insert into category values(1,10,'Top',null);
insert into category values(2,10,'General',1);
insert into category values(3,10,'Development',1);
insert into category values(4,10,'.Net',3);
insert into category values(5,10,'Java',3);
insert into category values(6,10,'C++',3);
insert into category values(7,10,'Big Data',1);
